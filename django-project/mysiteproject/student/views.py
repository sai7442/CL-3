...
from student.models import Country, City, Student, Company, CompanyInformation
...
def view_record(request):
    ...
    return render(request,'record.html',{'stud12':stud_record,'city12':city_record, 'Company12' :Company_record })
